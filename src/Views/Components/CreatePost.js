    ...
    <div className="app__createPost">
      {user ? (
        <div className="imageUpload">
          ...
          <div className="imageUpload__bottom">
            ...
            <button
              ...
              style={{
                color: caption ? "black" : "black",
                backgroundColor: caption ? "rgba(102, 201, 240, 0.555)" : "rgba(102, 201, 240, 0.555)",
                border: caption ? "rgba(102, 201, 240, 0.993) solid 2px" : "rgba(102, 201, 240, 0.993) solid 2px",
                borderRadius: caption ? "10px" : "10px",
        ...
        >
          ...
          <h2>Post your photo and add comment..</h2>
        </div>
      )}
    </div>
  );
